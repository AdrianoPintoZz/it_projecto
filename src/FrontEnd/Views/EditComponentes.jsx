...
import { getFamilias, getComponenteByNumeroPeca, updateComponente } from '../services/api';
import { useNavigate, useParams } from 'react-router-dom';
import '../styles/styles.css';
import { FaUserCircle } from "react-icons/fa";

const EditComponentes = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const componenteData = await getComponenteByNumeroPeca(numero_peca);
      setFormData({
        numero_peca: componenteData.numero_peca,
        nome: componenteData.nome,
        descricao: componenteData.descricao,
        id_categoria_comp: componenteData.id_categoria_comp,
      });
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateComponente(numero_peca, formData);
      alert("Componente atualizado com sucesso!");
      navigate('/showComponentes');
    } catch (error) {
            ...
            <div className="form-inner">
              <div className="form-content-wrapper">
                <div className="form-left">
                  <label>Referencia do Componente</label>
                  ...
                  <label>Categoria do Componente</label>
                    <select
                      name="id_categoria_comp" 
                      id="id_categoria_comp"
                      value={formData.id_categoria_comp}
...
export default EditComponentes;
