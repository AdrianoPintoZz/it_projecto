  ...
  useEffect(() => {
    ...
    async function fetchInstrucoes() {
      try {
        ...
        const agrupadas = instrucoes.reduce((acc, instrucao) => {
        ...
        const data = Object.values(agrupadas).map((lista) => {
    ...
    <div className="app-wrapper">
      ...
      <div className="main-container">
        <div className="form-section">
          <h1 style={{ textAlign: "center" }}>Lista de Instruções</h1>
      ...
      {selectedInstrucao && (
        ...
        >
          <div className="popup-content" onClick={(e) => e.stopPropagation()}>
            ...
            <p>
              <span
                title={selectedInstrucao.status}
                style={{
                  display: "inline-block",
                  width: 14,
                  height: 14,
