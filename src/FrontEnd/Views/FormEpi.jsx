...
import { addEpi } from "../services/api";
...
const FormEpi = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { numero_peca, nome, descricao, imagem } = formData;

    if (!numero_peca.trim() || !nome.trim() || !descricao.trim() || !imagem) {
    ...
    try {
      const response = await addEpi(data);
      if (response.error) {
        alert("Erro ao adicionar EPI!");
      } else {
        alert("EPI adicionada com sucesso!");
        setFormData({
          numero_peca: "",
          nome: "",
          descricao: "",
      ...
      console.error("Erro ao enviar EPI:", error);
      alert("Erro ao adicionar EPI!");
    }
  };
    ...
    <div className="app-wrapper">
      ...
      <div className="main-container">
        <aside className="sidebar">
          ...
          <h2>EPI</h2>
          <p className="active">Adicionar EPI</p>
            ...
            <div className="form-inner">
              <div className="form-content-wrapper">
                <div className="form-left">
                  <label htmlFor="numero_peca">Referencia da EPI</label>
                  <input
                    type="text"
                    name="numero_peca"
                    id="numero_peca"
